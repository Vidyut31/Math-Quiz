...
function send() {
    number1 = document.getElementById("question_number1").value;
    number2 = document.getElementById("question_number2").value;
    ...
    document.getElementById("question_number1").value = "";
